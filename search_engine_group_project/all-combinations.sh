mvn package && java -jar target/search_engine_group_project-1.0-SNAPSHOT.jar -analyzer standard -similarity classic -output_location output/output-standard-classic.txt -create_index
...
mvn package && java -jar target/search_engine_group_project-1.0-SNAPSHOT.jar -analyzer standard -similarity lmjm -output_location output/output-standard-lmjm.txt
mvn package && java -jar target/search_engine_group_project-1.0-SNAPSHOT.jar -analyzer standard -similarity axiomatic -output_location output/output-standard-axiomatic.txt

mvn package && java -jar target/search_engine_group_project-1.0-SNAPSHOT.jar -analyzer simple -similarity classic -output_location output/output-simple-classic.txt -create_index
...
mvn package && java -jar target/search_engine_group_project-1.0-SNAPSHOT.jar -analyzer simple -similarity lmjm -output_location output/output-simple-lmjm.txt
mvn package && java -jar target/search_engine_group_project-1.0-SNAPSHOT.jar -analyzer simple -similarity axiomatic -output_location output/output-simple-axiomatic.txt

mvn package && java -jar target/search_engine_group_project-1.0-SNAPSHOT.jar -analyzer english -similarity classic -output_location output/output-english-classic.txt -create_index
...
mvn package && java -jar target/search_engine_group_project-1.0-SNAPSHOT.jar -analyzer english -similarity lmjm -output_location output/output-english-lmjm.txt
mvn package && java -jar target/search_engine_group_project-1.0-SNAPSHOT.jar -analyzer english -similarity axiomatic -output_location output/output-english-axiomatic.txt

mvn package && java -jar target/search_engine_group_project-1.0-SNAPSHOT.jar -analyzer white-space -similarity classic -output_location output/output-white-space-classic.txt -create_index
...
mvn package && java -jar target/search_engine_group_project-1.0-SNAPSHOT.jar -analyzer white-space -similarity lmjm -output_location output/output-white-space-lmjm.txt
mvn package && java -jar target/search_engine_group_project-1.0-SNAPSHOT.jar -analyzer white-space -similarity axiomatic -output_location output/output-white-space-axiomatic.txt

mvn package && java -jar target/search_engine_group_project-1.0-SNAPSHOT.jar -analyzer stop -similarity classic -output_location output/output-stop-classic.txt -create_index
...
mvn package && java -jar target/search_engine_group_project-1.0-SNAPSHOT.jar -analyzer stop -similarity lmjm -output_location output/output-stop-lmjm.txt
mvn package && java -jar target/search_engine_group_project-1.0-SNAPSHOT.jar -analyzer stop -similarity axiomatic -output_location output/output-stop-axiomatic.txt

mvn package && java -jar target/search_engine_group_project-1.0-SNAPSHOT.jar -analyzer custom -similarity classic -output_location output/output-custom-classic.txt -create_index
...
mvn package && java -jar target/search_engine_group_project-1.0-SNAPSHOT.jar -analyzer custom -similarity lmjm -output_location output/output-custom-lmjm.txt
mvn package && java -jar target/search_engine_group_project-1.0-SNAPSHOT.jar -analyzer custom -similarity axiomatic -output_location output/output-custom-axiomatic.txt