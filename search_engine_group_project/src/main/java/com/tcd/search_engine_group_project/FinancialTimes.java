...
public class FinancialTimes implements IDocumentParser {
    ...
    public FinancialTimes(String dataPath, String indexPath, boolean createIndex, String stopwordsPath) throws IOException {
